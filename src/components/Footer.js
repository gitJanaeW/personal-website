        ...
        <footer className="">
            <div className='text-center'>
                ...
                <a href='https://www.linkedin.com/in/janae-welsh-01a52a23a/' target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="25" fill="#d1d5db" className="bi bi-linkedin" viewBox="0 0 16 16">
                ...
                <a href="mailto: janae.wel@gmail.com">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="25" fill="#d1d5db" className="bi bi-google" viewBox="0 0 16 16">
